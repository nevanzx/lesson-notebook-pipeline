...
| Assessment | Encrypted collect-only assignment — 20 situational items (10 mc · 4 tf · 4 id · 2 sa), marked by the teacher from the decrypted key file, authored per `skeleton/question-craft.md` (mc easy · tf hard · id medium · sa analysis). With build.json "assignment":"dag", Section 7 is a pure DAG scenario instead (dag-craft.md). |
