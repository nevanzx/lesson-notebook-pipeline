  ...
  init: function (root, d) {
    ...
    (d.cards || []).forEach(function (c) {
      var btn = LN.h("button", { type: "button", class: "fl-card", "aria-pressed": "false" }, [
        LN.h("span", { class: "fl-front", text: c.q }),
        LN.h("span", { class: "fl-back", text: c.a })
      ]);
    ...
    wrap.appendChild(LN.h("p", { class: "fl-hint", text: "Click a card to reveal its answer. In print both sides show." }));
