...
| Distinguish two confused concepts | `sort-statement` | `{left, right, items:[{t, a:'left'\|'right'\|'both'}]}` (8–12 items) | `<div data-component="sort-statement" data-key="sort1"></div>` |
