...
LN.data.assign7 = {
  ...
  "items": [
    { "type": "mc", "prompt": "A friend begs Aling Nena: cut the plate price from 160 to 140 and the noon crowd will double its loyalty. Fixed cost stays 45,000 and variable cost stays 80 a plate. What happens to break-even?",
      "choices": ["It falls to about 521 plates", "It rises to exactly 750 plates", "It stays near 563 plates", "It jumps past any reachable count"], "ans": 1 },
    { "type": "mc", "prompt": "The charcoal supplier hikes the price; variable cost climbs from 80 to 95 a plate while the price holds at 160 and fixed cost at 45,000. The lab recomputes to:",
      "choices": ["Stays at 562.5 plates", "Rises to exactly 750 plates", "Rises to about 692 plates", "There is no break-even anymore"], "ans": 2 },
    { "type": "mc", "prompt": "At 750 expected plates, the margin of safety against the 562.5-plate break-even is 25%. A cousin asks what that 25% actually states. Best answer:",
      "choices": ["Volume can fall 25% before the cart starts losing money", "25% of the plates sold are always miscounted by staff", "Price can drop 25% per plate with no effect", "Profit equals 25% of the revenue earned each month"], "ans": 0 },
    ...
    { "type": "mc", "prompt": "Aling Nena accepts one single change. Which move lowers the break-even point the most while leaving the 160-peso price untouched?",
      "choices": ["Raise fixed cost for a bigger cart", "Cut the variable cost per plate", "Promise a far higher expected volume", "Print extra banana-leaf wraps each morning"], "ans": 1 },
    { "type": "mc", "prompt": "Two stalls carry the identical 563-plate break-even. Stall A expects 570 plates; Stall B expects 900. The lesson's own risk rule says:",
      "choices": ["Both stalls carry equal risk because BEPs are equal", "Stall A is riskier — volume sits on its break-even", "Stall B is riskier — more volume, more variable cost", "Risk cannot be discussed at all with these numbers"], "ans": 1 },
    { "type": "mc", "prompt": "A prank proposal sets the plate price equal to its 80-peso variable cost. The lab leaves the price field at 160 but the class debates what would happen. Correct verdict:",
      "choices": ["Break-even rises but stays computable", "No volume ever covers fixed cost", "Break-even lands exactly at fixed cost", "Break-even falls at once to zero"], "ans": 1 },
    { "type": "mc", "prompt": "The rainy-month preset sells only 520 plates against a 562.5-plate break-even. What does the model actually say about that month?",
      "choices": ["It breaks even, since the gap is under ten percent", "It loses; each short plate still adds its 80-peso margin", "It profits, because fixed cost is spread out thinner", "The model refuses to judge a month under 600"], "ans": 1 },
